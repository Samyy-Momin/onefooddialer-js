...
export default function Layout({ children, title }) {
  ...
  const getNavigationItems = () => {
    ...
    const baseItems = [{ name: 'Dashboard', href: '/', icon: 'dashboard' }];
        ...
        <nav className="mt-8 px-4">
          <div className="space-y-2">
            {navigationItems.map(item => (
              ...
              >
                <div className="h-5 w-5 mr-3">{getIcon(item.icon)}</div>
                {item.name}
              </Link>
            ))}
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3 flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">{user.currentBusiness?.name}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-10 bg-white shadow-sm border-b border-gray-200">
          <div className="flex items-center justify-between h-16 px-4">
            <div className="flex items-center">
              ...
              {title && <h1 className="ml-4 text-xl font-semibold text-gray-900">{title}</h1>}
            </div>
        ...
        <footer className="bg-white border-t border-gray-200 py-4">
          <div className="px-4 text-center text-sm text-gray-500">
            © 2025 OneFoodDialer. All rights reserved.
          </div>
        </footer>
      </div>
    </div>
